...
import { mean, stdev, detect, evaluate, renderIntent, type BandConfig, type Observation } from './control-bands';
...
/** Dated observations for a value series. */
const obs = (vs: number[]): Observation[] =>
